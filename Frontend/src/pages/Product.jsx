              ...
              {productData.sizes.map((item, index) => (
                <button
                  ...
                  className={`border py-2 px-4 bg-gray-100 ${
                    item === size ? "border-orange-500 ring-1 ring-orange-300" : ""
                  }`}
                  key={index}
                >
                  {item}
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            doloribus natus qui cupiditate ipsa libero molestias quia
            perferendis, voluptates, numquam perspiciatis reiciendis impedit
            dolorum ducimus sit pariatur illum.
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Expedita
            id quaerat velit voluptate, modi iure suscipit ipsa ratione iusto
            inventore?
          </p>
        </div>
      </div>
