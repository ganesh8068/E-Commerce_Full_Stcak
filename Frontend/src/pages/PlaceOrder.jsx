        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg-flex-row">
            ...
            >
              <p
                className={`w-3.5 h-3.5 border rounded-full ${
                  method === "stripe" ? "bg-green-400 border-green-500" : ""
                }`}
              ></p>
            ...
            >
              <p
                className={`w-3.5 h-3.5 border rounded-full ${
                  method === "razorpay" ? "bg-green-400 border-green-500" : ""
                }`}
              ></p>
            ...
            >
              <p
                className={`w-3.5 h-3.5 border rounded-full ${
                  method === "cod" ? "bg-green-400 border-green-500" : ""
                }`}
              ></p>
          ...
          <div className="w-full text-end mt-6">
              <button
                ...
                className="bg-black text-white px-16 py-3 text-sm shadow"
              >
                PLACE ORDER
              </button>
            </div>
